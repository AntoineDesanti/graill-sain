...
public class Producer {
    ...
    public static List<Producer> producers = new ArrayList(Arrays.asList(
            ...
            new Producer("Brin de paille","1335 Raleigh Vista Suite 041 - Rio Rancho, ID / 30968", 43.74382040324239, 7.292801144604989, false),
            new Producer("Le Panier du Fermier","6903 Bechtelar View Apt. 943 - Altoona, FL / 92742", 43.136960735060036, 5.796301971237862, true),
